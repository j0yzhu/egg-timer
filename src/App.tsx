    ...
    return (
        <div style={{ backgroundImage: `url(${bgImage})` }} className="bg-cover bg-center h-screen">
            <div className="flex justify-center p-6">
                ...
                bg-gradient-to-b from-[#e2c3a8] to-[#c28d5c] w-[384px] h-[500px]
                rounded-[50%/65%_65%_45%_45%] drop-shadow-[0px_25px_10px_rgba(0,0,0,0.3)]">
                    ...
                    }
                    {
                        clicked &&
                        <div
                            className="flex flex-col items-center justify-center h-screen font-serif text-xl font-medium text-[#6b4320]">
